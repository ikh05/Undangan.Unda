<section id="cover" class="bg-1">
	<div class="container position-relative" style="height: 100%; width: 100%;">
		...
		<div class="position-relative family-pinyon text-end pt-5" style="z-index: 2;">
			<h1 class="bold me-5 display-3">Undangan</h1>
			<h1 class="bold display-3">Pernikahan</h1>
		</div>
		<div class=" gambar-mempelai position-absolute top-50 translate-middle-y w-100">
		...
		<div class="row">Kepada Yth.</div>
		<div class="row"><?= $data['to'] ?></div>
		<div class="row">Mohon maaf, apabila ada kesalahan dalam penulisan nama dan gelar</div> -->
	</div>
</section>
<section></section>
